...
client_id = 'spotify api is free'
client_secret = 'spotify api is free'
...
def generate_html_content():
    ...
    print('Wrote code to GitHub repo with no issues!!! :)')
